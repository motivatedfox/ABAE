...
def evaluation(true, predict, domain):
    ...
    if domain == 'restaurant':
        ...
        print(classification_report(true_label, predict_label,
                                    ['Food', 'Flavor', 'Price', 'Location', 'Price', 'Atmosphere'], digits=3))
...
cluster_map = {
    0: 'Miscellaneous', 1: 'Miscellaneous', 2: 'Miscellaneous', 3: 'Food',
    4: 'Flavor', 5: 'Price', 6: 'Location',  7: 'Atmosphere', 8: 'Miscellaneous',
    9: 'Miscellaneous', 10: 'Miscellaneous', 11: 'Food', 12: 'Miscellaneous', 13: 'Miscellaneous'
}
